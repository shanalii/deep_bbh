...
current_dir = Path()
assert (current_dir / 'deep_bbh.py').is_file(), 'Script should be executed in the pytorch-template directory'
...
ignore = [".git", "data", "saved", "deep_bbh.py", "LICENSE", ".flake8", "README.md", "__pycache__"]
